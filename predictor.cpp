...
void GetImageFile(const std::string image_file,
    ...
    std::cout << "img_shape:" << im_ori.size;
    if (im_ori.empty()) {
...
int main(int argc, char* argv[]) {
    ...
    std::string json_file = "Inception/Inception_BN-symbol.json";
    std::string param_file = "Inception/Inception_BN-0039.params";
    std::string synset_file = "Inception/synset.txt";
    std::string nd_file = "Inception/mean_224.nd";
